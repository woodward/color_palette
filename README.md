...
This hex package adds 511 additional named colors to use in Elixir terminal scripts, based on 
...
Color names were obtained from [color-name.com](https://www.color-name.com/),  
[thecolorapi.com](https://www.thecolorapi.com/), and [ColorHexa.com](https://www.colorhexa.com/) .
`Mix.install/2` Elixir scripts to download this data are found [here](https://github.com/woodward/color_palette/blob/main/bin/download_color-name_data.exs), 
